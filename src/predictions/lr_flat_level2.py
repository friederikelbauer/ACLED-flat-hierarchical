...
logging.basicConfig(
    filename="src/logs/lr_flat_level2.log", level=logging.DEBUG, filemode="w"
)
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="lr/lr_flat_count_vectorizer_level2",
)
...
#     X=x_train,
#     y=y_train,
#     name="lr/flat_crossvalidation_lr_countvectorizer_level2",
# )
...
#     X=x_train,
#     y=y_train,
#     name="lr/flat_crossvalidation_lr_tfidf_level2",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="lr/lr_flat_fasttext_level2",
)
evaluation.evaluate_flat(level=2)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="lr/flat_crossvalidation_lr_fasttext_level2",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="lr/lr_flat_word2vec_level2",
)
evaluation.evaluate_flat(level=2)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="lr/flat_crossvalidation_lr_word2vec_level2",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="lr/lr_flat_bert_vectorizer_level2",
)
evaluation.evaluate_flat(level=2)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="lr/flat_crossvalidation_lr_bert_vectorizer_level2",
# )
