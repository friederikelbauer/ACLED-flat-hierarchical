...
logging.basicConfig(
    filename="src/logs/rf_flat_level1.log", level=logging.DEBUG, filemode="w"
)
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="rf/rf_flat_count_vectorizer_level1",
)
...
#     X=x_train,
#     y=y_train,
#     name="rf/flat_crossvalidation_rf_countvectorizer_level1",
# )
...
#     X=x_train,
#     y=y_train,
#     name="rf/flat_crossvalidation_rf_tfidf_level1",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="rf/rf_flat_fasttext_level1",
)
evaluation.evaluate_flat(level=1)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="rf/flat_crossvalidation_rf_fasttext_level1",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="rf/rf_flat_word2vec_level1",
)
evaluation.evaluate_flat(level=1)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="rf/flat_crossvalidation_rf_word2vec_level1",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="rf/rf_flat_bert_vectorizer_level1",
)
evaluation.evaluate_flat(level=1)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="rf/flat_crossvalidation_rf_bert_vectorizer_level1",
# )
