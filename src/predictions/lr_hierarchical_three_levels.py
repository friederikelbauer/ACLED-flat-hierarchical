...
evaluation = ModelEvaluator(
    y_test, y_pred, name="lr/three_levels_lr_hierarchical_count_vectorizer"
)
...
# Evaluation
evaluation = ModelEvaluator(
    y_test, y_pred, name="lr/three_levels_lr_hierarchical_tfidf"
)
# first level
...
# # Evaluation
evaluation = ModelEvaluator(
    y_test, y_pred, name="lr/three_levels_lr_hierarchical_fasttext"
)
...
# # Evaluation
evaluation = ModelEvaluator(
    y_test, y_pred, name="lr/three_levels_lr_hierarchical_word2vec"
)
...
# Evaluation
evaluation = ModelEvaluator(
    y_test, y_pred, name="lr/three_levels_lr_hierarchical_bert_vectorizer"
)
