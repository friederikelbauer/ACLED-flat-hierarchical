...
logging.basicConfig(
    filename="src/logs/svm_hierarchical.log", level=logging.DEBUG, filemode="w"
)
...
# model
classifier = createSVM().get_classifier()
...
evaluation = ModelEvaluator(
    y_test, y_pred, name="svm/svm_hierarchical_count_vectorizer"
)
# first level
...
#     local_classifier=createSVM().get_classifier(),
#     vectorizer=createCountVectorizer(),
#     X=x_train,
#     y=y_train,
#     name="svm/hierarchical_crossvalidation_svm_countvectorizer",
# )
...
# Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="svm/svm_hierarchical_tfidf")
# first level
evaluation.evaluate_hierarchical(
    make_matrix=False,
    hierarchy_level=1,
...
#     X=x_train,
#     y=y_train,
#     name="svm/hierarchical_crossvalidation_svm_tfidf",
# )
...
# # Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="svm/svm_hierarchical_fasttext")
# first level
evaluation.evaluate_hierarchical(
    make_matrix=False,
    hierarchy_level=1,
...
#     X=x_train,
#     y=y_train,
#     name="svm/hierarchical_crossvalidation_svm_fasttext",
# )
...
# # Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="svm/svm_hierarchical_word2vec")
# first level
evaluation.evaluate_hierarchical(
    make_matrix=False,
    hierarchy_level=1,
...
#     X=x_train,
#     y=y_train,
#     name="svm/hierarchical_crossvalidation_svm_word2vec",
# )
...
# Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="svm/svm_hierarchical_bert_vectorizer")
# first level
evaluation.evaluate_hierarchical(
    make_matrix=False,
    hierarchy_level=1,
...
#     X=x_train,
#     y=y_train,
#     name="svm/hierarchical_crossvalidation_svm_bert_vectorizer",
# )
