...
logging.basicConfig(
    filename="src/logs/rf_hierarchical.log", level=logging.DEBUG, filemode="w"
)
...
# Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="rf/rf_hierarchical_count_vectorizer")
# first level
...
#     local_classifier=createRF().get_classifier(),
#     vectorizer=createCountVectorizer(),
#     X=x_train,
#     y=y_train,
#     name="rf/hierarchical_crossvalidation_rf_countvectorizer",
# )
...
# Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="rf/rf_hierarchical_tfidf")
# first level
evaluation.evaluate_hierarchical(
    make_matrix=False,
    hierarchy_level=1,
...
#     X=x_train,
#     y=y_train,
#     name="rf/hierarchical_crossvalidation_rf_tfidf",
# )
...
# Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="rf/rf_hierarchical_fasttext")
# first level
evaluation.evaluate_hierarchical(
    make_matrix=False,
    hierarchy_level=1,
...
#     X=x_train,
#     y=y_train,
#     name="rf/hierarchical_crossvalidation_rf_fasttext",
# )
...
# Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="rf/rf_hierarchical_word2vec")
# first level
evaluation.evaluate_hierarchical(
    make_matrix=False,
    hierarchy_level=1,
...
#     X=x_train,
#     y=y_train,
#     name="rf/hierarchical_crossvalidation_rf_word2vec",
# )
...
Evaluation
evaluation = ModelEvaluator(y_test, y_pred, name="rf/rf_hierarchical_bert_vectorizer")
# first level
evaluation.evaluate_hierarchical(
    make_matrix=False,
    hierarchy_level=1,
...
#     X=x_train,
#     y=y_train,
#     name="rf/hierarchical_crossvalidation_rf_bert_vectorizer",
# )
