...
evaluation = ModelEvaluator(
    y_test, y_pred, name="svm/three_levels_svm_hierarchical_count_vectorizer"
)
...
# Evaluation
evaluation = ModelEvaluator(
    y_test, y_pred, name="svm/three_levels_svm_hierarchical_tfidf"
)
# first level
...
# # Evaluation
evaluation = ModelEvaluator(
    y_test, y_pred, name="svm/three_levels_svm_hierarchical_fasttext"
)
...
# # Evaluation
evaluation = ModelEvaluator(
    y_test, y_pred, name="svm/three_levels_svm_hierarchical_word2vec"
)
...
# Evaluation
evaluation = ModelEvaluator(
    y_test, y_pred, name="svm/three_levels_svm_hierarchical_bert_vectorizer"
)
