...
logging.basicConfig(
    filename="src/logs/svm_flat_level1.log", level=logging.DEBUG, filemode="w"
)
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="svm/svm_flat_count_vectorizer_level1",
)
...
#     X=x_train,
#     y=y_train,
#     name="svm/flat_crossvalidation_svm_countvectorizer_level1",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="svm/svm_flat_tfidf_level1",
)
evaluation.evaluate_flat(level=1)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="svm/flat_crossvalidation_svm_tfidf_level1",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="svm/svm_flat_fasttext_level1",
)
evaluation.evaluate_flat(level=1)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="svm/flat_crossvalidation_svm_fasttext_level1",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="svm/svm_flat_word2vec_level1",
)
evaluation.evaluate_flat(level=1)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="svm/flat_crossvalidation_svm_word2vec_level1",
# )
...
evaluation = ModelEvaluator(
    y_test,
    y_pred,
    name="svm/svm_flat_bert_vectorizer_level1",
)
evaluation.evaluate_flat(level=1)
evaluation.save_flat_predictions(x_test=x_test)
evaluation.make_confusionmatrix()
...
#     X=x_train,
#     y=y_train,
#     name="svm/flat_crossvalidation_svm_bert_vectorizer_level1",
# )
